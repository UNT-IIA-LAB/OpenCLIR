...
# -*- coding: utf-8 -*-
# Created by Haihua on 11/12/2018
...
class Stemmer:
    ...
    def STO(self,token, K):
        ...
        if K == 0:
            ...
            if token == "ya": return "have"

        if K == 1:
            if token == "li": return "did,"
            if token == "na": return "is,"
            if token == "ta": return "will,"
            if token == "ki": return "while,"
